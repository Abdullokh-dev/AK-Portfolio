    ...
    <div class="col">
      ...
      <div class="row d-flex justify-content-center">
        <div class="col-11 col-xl-8 mt-5">
          <div class="row">
            <div class="col-12 col-md-6 text-center text-xl-start" data-aos="flip-left" data-aos-delay="800">
              <img src="../assets/baz.png" class="second-image mt-3" width="275" height="275" alt="#">
            </div>
            <div class="col-12 col-md-6 text-center" data-aos="zoom-in-right" data-aos-delay="1000">
              <div class="row">
                ...
                <div class="col d-flex justify-content-between  gap-4 gap-md-2 gap-lg-3">
                  <div class="card text-center mt-5" style="width: 130px;" data-aos="fade-in">
                    <div class="card-content">
                      ...
                      <div class="card-text-1">Completed</div>
                      <div class="card-text-2 mb-2">20 + Projects</div>
                    </div>
                  </div>
                  ...
                  <div class="card text-center mt-5" style="width: 130px;" data-aos="fade-in" data-aos-delay="500">
                    <div class="card-content">
                      ...
                      <div class="card-text-1 mt-1">Experienced</div>
                      <div class="card-text-2 mb-2">1 + year</div>
                    </div>
                  </div>
                </div>
      ...
      <div class="row">
        <div class="col-12 d-flex justify-content-center" data-aos="fade-up">
          <span class="experience-text mt-3" id=text>The Percentages Below Represent How Much Of Which Technologies I Used During My Experience.</span>
        </div>
      </div>
      ...
      <div class="row mt-5">
        <div class="col mt-5 text-center">
          <div> <span class="title" id="services">What I Offer</span> </div>
          <div> <span class="title-info">My Services</span> </div>
        </div>
      </div>
      ...
      <div class="row mt-5">
        <div class="col mt-5 text-center">
          <div> <span class="title" id="portfolio">Recent Works</span> </div>
          <div> <span class="title-info">My Portfolio</span> </div>
        </div>
      </div>
      ...
      <div class="row d-flex justify-content-center">
        <div class="col-10 col-md-12 col-lg-10 col-xl-8 col-xxl-7 d-flex justify-content-center">
          ...
          <div class="row gap-lg-5 d-flex justify-content-center">
            ...
            <div class="col-12 mt-5 project-card" data-aos="zoom-in"  data-aos-delay="200">
            ...
            <div class="col-12 mt-5 me-md-5 project-card" data-aos="zoom-in" data-aos-delay="300">
            ...
            <div class="col-12 mt-5 project-card" data-aos="zoom-in" data-aos-delay="400">
            ...
            <div class="col-12 mt-5 me-md-5 project-card" data-aos="zoom-in" data-aos-delay="500">
              <div class="experience-card-title">
            ...
            <div class="col-12 mt-5 project-card" data-aos="zoom-in" data-aos-delay="600">
              <div class="experience-card-title">
      ...
      <div class="row my-5">
        <div class="col mt-5 text-center" data-aos="fade-in">
          <div> <span class="title" id="contact">Contact Me</span> </div>
          <div> <span class="title-info">get in touch </span> </div>
        </div>
