...
<template>
  ...
  <div class="row d-flex justify-content-center">
    <div class="col-10 col-md-12 col-lg-10 col-xl-8 col-xxl-7 d-flex justify-content-center">
      ...
      <div class="row gap-lg-5 d-flex justify-content-center">
        ...
        <div class="col-12 mt-5 me-md-5 project-card" data-aos="zoom-in" data-aos-delay="600">
        ...
        <div class="col-12 mt-5 project-card" data-aos="zoom-in" data-aos-delay="800">
        ...
        <div class="col-12 mt-5 me-md-5 project-card" data-aos="zoom-in" data-aos-delay="1000">
          <div class="experience-card-title">
        ...
        <div class="col-12 mt-5 project-card" data-aos="zoom-in" data-aos-delay="1200">
          <div class="experience-card-title">
  ...
  <div class="row mt-5">
    ...
    <div class="col-12 mt-5 gap-3 gap-sm-5 d-flex justify-content-center" data-aos="fade-in" data-aos-delay="400">
      ...
      <a target="_blank" href="https://www.instagram.com/Abdullokh_dev/" class="contact-bar inst" data-aos="fade-in" data-aos-delay="600">
      ...
      <a href="mailto:abdulloh3525dev@gmail.com" class="contact-bar mail" data-aos="fade-in" data-aos-delay="800">
        <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
