...
<template>
  ...
  <div class="row mt-5">
    ...
    <div class="col-12 mt-5 gap-3 gap-sm-5 d-flex justify-content-center">
      ...
      <a target="_blank" href="https://www.instagram.com/Abdullokh_dev/" class="contact-bar">
      ...
      <a href="mailto:abdulloh3525dev@gmail.com" class="contact-bar">
        <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
