<template>
  ...
  <div class="row">
    <div class="col d-flex justify-content-center">
      <button class="download-button m-3 mt-4"> Download CV </button>
  ...
  <div class="row my-5">
    <div class="col text-center">
      <div> <span class="title">About me</span> </div>
            ...
            <div class="col d-flex justify-content-center justify-content-lg-start  gap-4 gap-md-2 gap-lg-3">
              <div class="card text-center mt-5" style="width: 130px;">
                <div class="card-content">
                  ...
                  <div class="card-text-2 mb-2">48 + Projects</div>
                </div>
              </div>
  ...
  <div class="row mt-5">
    <div class="col mt-5 text-center">
      <div> <span class="title">What I Offer</span> </div>
      ...
      <div class="row groups-card  d-flex justify-content-center">
        ...
        <div class="col-12 mt-5 experience-card">
          ...
          <p class="offer-description mt-3">
            You want to launch your website, you need a new design for your future site? Contact me and we will discuss your needs and desires.
          </p>
